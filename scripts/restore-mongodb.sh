...
#---------------------------------------------------------
S3_BUCKET="apps-hosting-prod-storage"
MONGODB_HOST="mongodb.lawrencemcdaniel.com:27017"
...
mongorestore -d apps_prod_edx ~/backups/mongodb/mongo-dump-${BACKUP_KEY}/edxapp --host $MONGODB_HOST
